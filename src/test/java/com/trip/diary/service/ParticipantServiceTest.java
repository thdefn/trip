...
class ParticipantServiceTest {
    ...
    void getTripParticipantsTest_successWhenReaderIsParticipants() {
        ...
        //then
        assertFalse(result.get(0).getIsReader());
        assertTrue(result.get(0).getIsAccepted());
        assertNotEquals(participant1.getNickname(), result.get(1).getNickname());
        assertTrue(result.get(1).getIsReader());
        assertFalse(result.get(1).getIsAccepted());
    }
    ...
    void getInvitedTripListTest_success() {
        ...
        assertTrue(result.get(0).getParticipants().get(0).getIsAccepted());
        assertFalse(result.get(0).getParticipants().get(1).getIsAccepted());
    }
    ...
    void invite_success() {
        ...
        given(participantRepository.existsByTripAndMember(any(), any())).willReturn(false);
        //when
        participantService.invite(1L, 4L, member);
        //then
    ...
    void kickOut_success() {
        ...
        //when
        participantService.kickOut(1L, 4L, member);
        //then
        verify(participantRepository, times(1)).delete(any());
    }
